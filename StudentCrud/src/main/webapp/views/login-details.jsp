      ...
      <header>
        <div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:160px;">
          ...
          <div id="menu" class="w3-hide w3-white w3-card">
            <c:forEach begin="0" end="${lists.length()-1}" var = "list">
              <a id='${lists.getJSONObject(list).getString("id")}' class="w3-bar-item w3-button">${lists.getJSONObject(list).getString("name")}</a><br>
            </c:forEach>
          </div>
        </div>
      </header>
